...
local on_attach = function(client, bufnr)
  ...
  nnoremap('<leader>vrn', vim.lsp.buf.rename, bufopts, "Rename")
  nnoremap('<leader>vca', vim.lsp.buf.code_action, bufopts, "Code actions")
  vim.keymap.set('v', "<leader>ca", "<ESC><CMD>lua vim.lsp.buf.range_code_action()<CR>",
    { noremap=true, silent=true, buffer=bufnr, desc = "Code actions" })
  nnoremap('<leader>fmt', function() vim.lsp.buf.format { async = true } end, bufopts, "Format file")
...
local config = {
  ...
  cmd = {
    ...
    '-jar', vim.fn.glob('/home/davide/workspace/java_lib/jdtls/jdt-language-server-1.9.0-202203031534/plugins/org.eclipse.equinox.launcher_*.jar'),

    -- The configuration for jdtls is also placed where jdtls was installed. This will
    -- need to be updated depending on your environment
    '-configuration', '/home/davide/workspace/java_lib/jdtls/jdt-language-server-1.9.0-202203031534/config_linux',
